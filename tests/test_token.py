...
def test_initial_state(token, owner):
    ...
    assert token.totalSupply() == 10000000000000000000
    assert token.balanceOf(owner) == 10000000000000000000
...
def test_transfer(token, owner, receiver):
    ...
    assert owner_balance == 10000000000000000000
    ...
    owner_balance = token.balanceOf(owner)
    assert owner_balance == 10000000000000000000 - 100
...
def test_transfer_from(token, owner, accounts):
    ...
    assert token.balanceOf(owner) == 10000000000000000000 - 300
...
def test_mint(token, owner, receiver):
    ...
    assert totalSupply == 10000000000000000000
    ...
    totalSupply = token.totalSupply()
    assert totalSupply == 10000000000000000420
...
def test_burn(token, owner):
    ...
    owner_balance = token.balanceOf(owner)
    assert owner_balance == 9999999999999999580

    totalSupply = token.totalSupply()
    assert totalSupply == 9999999999999999580


def test_permit(chain, token, owner, receiver, TokenPermit):
    """
    ...
    permit = TokenPermit(owner.address, receiver.address, amount, nonce, deadline)
